...
st.caption("Singapore FSI Demo — Snowflake Dynamic Tables + Cortex AI")
...
with tab3:
    ...
    st.markdown("Open payment exceptions requiring attention. Run **Cortex AI** analysis for AI-recommended resolution.")
    st.divider()
    ...
    if exc_df.empty:
        ...
        if labels:
            ...
            st.divider()
            if st.button("Analyze with Cortex AI", type="primary", use_container_width=True):
                with st.spinner("Cortex AI analyzing exception..."):
